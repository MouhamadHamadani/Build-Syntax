    ...
    <div class="container mx-auto px-6 text-center">
        <div class="max-w-3xl mx-auto fade-in">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo strpos($_SERVER['PHP_SELF'], 'pages/') !== false ? 'contact' : 'pages/contact'; ?>" class="bg-white text-brand-blue text-lg font-semibold px-8 py-4 rounded-lg hover:bg-gray-100 transition-all duration-200 shadow-lg">
                    Get Free Consultation
                </a>
                <a href="<?php echo strpos($_SERVER['PHP_SELF'], 'pages/') !== false ? 'services' : 'pages/services'; ?>" class="border-2 border-white text-white text-lg font-semibold px-8 py-4 rounded-lg hover:bg-white hover:text-brand-blue transition-all duration-200">
                    View Services
                </a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="md:col-span-2">
                <div class="flex items-center space-x-3 mb-4">
                    <img src="<?php echo strpos($_SERVER['PHP_SELF'], 'pages/') !== false ? '../assets/images/icon.png' : 'assets/images/icon.png'; ?>" alt="Build Syntax Icon" class="h-8 w-8">
                    <span class="text-xl font-bold">Build Syntax</span>
                </div>
                <p class="text-gray-300 mb-4 max-w-md">
                    Your Vision, Our Code. We are a Beirut-based development partner dedicated to transforming your ideas into powerful, modern, and reliable digital solutions.
                </p>
