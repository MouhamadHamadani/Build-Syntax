    ...
    <div class="space-y-4">
      <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4">
        ...
        <label class="flex items-center gap-3 cursor-pointer">
          <input wire:model="published" type="checkbox" class="w-4 h-4 rounded text-blue-600 focus:ring-blue-500">
        ...
        <div>
          ...
          <input wire:model="slug" type="text"
            class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
          <p class="text-xs text-gray-400 mt-1">Changing this will break existing links.</p>
        </div>
