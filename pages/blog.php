...
<main>
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-6">
            <div class="text-center mb-12 fade-in">
                ...
                <p class="text-gray-600 text-lg">Our latest insights on web development and business growth.</p>
            </div>
            <div class="max-w-4xl mx-auto">
                <?php $featured_post = $posts[0]; ?>
                <article class="bg-gray-50 rounded-xl overflow-hidden shadow-lg fade-in">
                    ...
                    <div class="p-8">
                        ...
                        <h2 class="text-2xl md:text-3xl font-bold text-gray-900 mb-4"><?php echo htmlspecialchars($featured_post['title']); ?></h2>
                        <p class="text-gray-600 text-lg leading-relaxed mb-6"><?php echo htmlspecialchars($featured_post['excerpt']); ?></p>
    ...
    <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16 fade-in">
                ...
                <p class="text-gray-600 text-lg max-w-2xl mx-auto">Stay updated with our latest thoughts on web development, technology, and business growth.</p>
            </div>

            <?php if (!empty($posts)): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <?php foreach (array_slice($posts, 1) as $post): ?>
                <article class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 fade-in">
                ...
                <article class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 fade-in">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3">5 Essential Features Every Modern Website Needs</h3>
                        <p class="text-gray-600 mb-4">Discover the must-have features that make websites successful in today's competitive digital landscape.</p>
                ...
                <article class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 fade-in">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3">Mobile-First Design: Why It Matters More Than Ever</h3>
                        <p class="text-gray-600 mb-4">Learn why mobile-first design is crucial for success in the Middle East market and beyond.</p>
                        <a href="#" class="inline-flex items-center text-brand-blue font-semibold hover:text-brand-blue-dark transition-colors">
                            Read More
                            <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                ...
                <article class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 fade-in">
                    ...
                    <div class="p-6">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3">SEO Best Practices for Lebanese Businesses</h3>
                        <p class="text-gray-600 mb-4">Optimize your website for local and regional search to attract more customers in the MENA region.</p>
                        <a href="#" class="inline-flex items-center text-brand-blue font-semibold hover:text-brand-blue-dark transition-colors">
                            Read More
                            <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
            ...
            <div class="text-center py-12">
                ...
                <p class="text-gray-600">We're working on some great content. Check back soon!</p>
            </div>
            <?php endif; ?>
        </div>
    </section>
    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-6">
            <div class="max-w-4xl mx-auto text-center">
                <div class="bg-gray-50 rounded-xl p-8 md:p-12 fade-in">
    ...
    <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16 fade-in">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Explore Topics</h2>
                <p class="text-gray-600 text-lg max-w-2xl mx-auto">Browse articles by category to find exactly what you're looking for.</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <a href="#" class="bg-white rounded-lg p-6 text-center hover:shadow-lg transition-all duration-300 fade-in">
                    ...
                    <p class="text-gray-600 text-sm">Latest trends and best practices</p>
                </a>
                ...
                <a href="#" class="bg-white rounded-lg p-6 text-center hover:shadow-lg transition-all duration-300 fade-in">
                    ...
                    <h3 class="text-lg font-bold mb-2">Business Growth</h3>
                    <p class="text-gray-600 text-sm">Strategies for digital success</p>
                </a>
                ...
                <a href="#" class="bg-white rounded-lg p-6 text-center hover:shadow-lg transition-all duration-300 fade-in">
                    ...
                    <p class="text-gray-600 text-sm">Emerging tech and innovations</p>
                </a>
                ...
                <a href="#" class="bg-white rounded-lg p-6 text-center hover:shadow-lg transition-all duration-300 fade-in">
                    ...
                    <h3 class="text-lg font-bold mb-2">Case Studies</h3>
                    <p class="text-gray-600 text-sm">Real project insights</p>
                </a>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-brand-blue text-white">
        <div class="container mx-auto px-6 text-center">
            <div class="max-w-3xl mx-auto fade-in">
                ...
                <p class="text-xl mb-8 opacity-90">Let's turn your ideas into reality with professional web development services.</p>
