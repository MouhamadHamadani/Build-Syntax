...
<head>
    ...
    <style>
        ...
        .bg-dark-primary { background-color: #0F0F23; }
        .bg-dark-secondary { background-color: #1A1A2E; }
        .bg-dark-tertiary { background-color: #16213E; }
        .text-dark-primary { color: #E5E7EB; }
        .text-dark-secondary { color: #9CA3AF; }
        .text-dark-accent { color: #F3F4F6; }
        .border-dark { border-color: #374151; }
        .bg-brand-blue { background-color: #4A90E2; }
        .text-brand-blue { color: #4A90E2; }
